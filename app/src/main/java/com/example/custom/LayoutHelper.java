...
public class LayoutHelper {
    ...
    public static ConstraintLayout.LayoutParams createConstraint(int width, int height) {
        return new ConstraintLayout.LayoutParams(getSize(width), getSize(height));
    }

    public static ConstraintLayout.LayoutParams createConstraint(int width, int height, float leftMargin, float topMargin, float rightMargin, float bottomMargin) {
        ConstraintLayout.LayoutParams layoutParams = new ConstraintLayout.LayoutParams(getSize(width), getSize(height));
        layoutParams.setMargins(AndroidUtilities.dp(leftMargin), AndroidUtilities.dp(topMargin), AndroidUtilities.dp(rightMargin), AndroidUtilities.dp(bottomMargin));
        return layoutParams;
    }

    public static ConstraintLayout.LayoutParams createConstraintNotDpi(int width, int height) {
